<template>
  <nav class="fixed top-0 left-0 z-20 w-full border-b h-[4.5rem] border-gray-200 bg-white py-2.5 px-6 sm:px-4">
    <div class="container mx-auto flex max-w-6xl flex-wrap items-center justify-between">
      <RouterLink to="/" class="flex items-center">
        ...
        <span class="self-center whitespace-nowrap text-xl font-semibold">Urban Store</span>
      </RouterLink>
      <div class="mt-2 sm:mt-0 sm:flex md:order-2">
        ...
        <template v-if="authStore.isAuthenticated">
          <RouterLink v-if="authStore.isAdmin" :to="{ name: 'admin' }"
            class="rounde mr-3 hidden border border-blue-700 py-1.5 px-6 text-center text-sm font-medium text-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 md:inline-block rounded-lg">
            Admin
          </RouterLink>
